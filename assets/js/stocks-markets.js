...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (rusFilterElement) {
    toggleStocksMarkets("russian-stocks", rusFilterElement);
  }
});

function toggleStocksMarkets(targetClass) {
...
document.addEventListener("DOMContentLoaded", () => {
  const filterItemsContainer = document.querySelector(
    ".stocks-filters-countries__items"
  );
...
// Реализация подцветки кнопок сортировки стран END
